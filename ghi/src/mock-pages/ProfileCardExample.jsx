                        ...
                        <div className="pb-6">
                            ...
                            <div className="w-full text-center">
                                ...
                                <div className="flex space-x-2">
                                    <a
                                    className="p-1 -m-1 text-gray-400 hover:text-red-500 focus:outline-none focus-visible:ring-2 ring-primary"
                                    href="https://www.linkedin.com/in/joonhyukjang/"
                                    rel="noreferrer"
                                    aria-label="User on Twitter"
                                    target="_blank"
                                    >
                                    <svg
