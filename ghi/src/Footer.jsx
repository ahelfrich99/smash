...
export const Footer = () => {
    return (
        <footer aria-label="Site Footer" class="bg-white lg:grid lg:grid-cols-5 h-12">
            <div class="relative block h-32 lg:col-span-2 lg:h-full">
            <img
                src="https://cdn.discordapp.com/attachments/1054958023698825266/1113298260984070144/0_1_22.png"
                alt=""
            ...
            <div class="pt-12 mt-12 border-t border-gray-100">
                ...
                <p class="mt-8 text-xs text-gray-500 sm:mt-0">
                    &copy; 2023. Bangerz Only. All rights reserved.
                </p>
                </div>
            </div>
            </div>
